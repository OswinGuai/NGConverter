...
_LOSS_EXPECTEDLOSSWEIGHTS = _descriptor.EnumDescriptor(
  ...
  full_name='protos.Loss.ExpectedLossWeights',
  filename=None,
  file=DESCRIPTOR,
  values=[
...
_LOSS_EQUALIZATIONLOSS = _descriptor.Descriptor(
  ...
  full_name='protos.Loss.EqualizationLoss',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='weight', full_name='protos.Loss.EqualizationLoss.weight', index=0,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='exclude_prefixes', full_name='protos.Loss.EqualizationLoss.exclude_prefixes', index=1,
...
_LOSS = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='equalization_loss', full_name='protos.Loss.equalization_loss', index=6,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='expected_loss_weights', full_name='protos.Loss.expected_loss_weights', index=7,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='min_num_negative_samples', full_name='protos.Loss.min_num_negative_samples', index=8,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='desired_negative_sampling_ratio', full_name='protos.Loss.desired_negative_sampling_ratio', index=9,
...
Loss = _reflection.GeneratedProtocolMessageType('Loss', (_message.Message,), dict(
  ...
  EqualizationLoss = _reflection.GeneratedProtocolMessageType('EqualizationLoss', (_message.Message,), dict(
    ...
    # @@protoc_insertion_point(class_scope:protos.Loss.EqualizationLoss)
    ))
  ,
  DESCRIPTOR = _LOSS,
  __module__ = 'protos.losses_pb2'
