...
_FASTERRCNN = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='use_matmul_crop_and_resize', full_name='protos.FasterRcnn.use_matmul_crop_and_resize', index=29,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='clip_anchors_to_image', full_name='protos.FasterRcnn.clip_anchors_to_image', index=30,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='use_matmul_gather_in_matcher', full_name='protos.FasterRcnn.use_matmul_gather_in_matcher', index=31,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='use_static_balanced_label_sampler', full_name='protos.FasterRcnn.use_static_balanced_label_sampler', index=32,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='use_static_shapes', full_name='protos.FasterRcnn.use_static_shapes', index=33,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='resize_masks', full_name='protos.FasterRcnn.resize_masks', index=34,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='use_static_shapes_for_eval', full_name='protos.FasterRcnn.use_static_shapes_for_eval', index=35,
...
_FASTERRCNN.fields_by_name['second_stage_classification_loss'].message_type = protos_dot_losses__pb2._CLASSIFICATIONLOSS
