...
_EVALCONFIG = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='batch_size', full_name='protos.EvalConfig.batch_size', index=0,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='num_visualizations', full_name='protos.EvalConfig.num_visualizations', index=1,
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='min_score_threshold', full_name='protos.EvalConfig.min_score_threshold', index=13,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='max_num_boxes_to_visualize', full_name='protos.EvalConfig.max_num_boxes_to_visualize', index=14,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='skip_scores', full_name='protos.EvalConfig.skip_scores', index=15,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='skip_labels', full_name='protos.EvalConfig.skip_labels', index=16,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='visualize_groundtruth_boxes', full_name='protos.EvalConfig.visualize_groundtruth_boxes', index=17,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='groundtruth_box_visualization_color', full_name='protos.EvalConfig.groundtruth_box_visualization_color', index=18,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='keep_image_id_for_visualization_export', full_name='protos.EvalConfig.keep_image_id_for_visualization_export', index=19,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='retain_original_images', full_name='protos.EvalConfig.retain_original_images', index=20,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='include_metrics_per_category', full_name='protos.EvalConfig.include_metrics_per_category', index=21,
