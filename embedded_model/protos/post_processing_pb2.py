...
_BATCHNONMAXSUPPRESSION = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='use_static_shapes', full_name='protos.BatchNonMaxSuppression.use_static_shapes', index=4,
