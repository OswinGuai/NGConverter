...
_REGIONSIMILARITYCALCULATOR = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='thresholded_iou_similarity', full_name='protos.RegionSimilarityCalculator.thresholded_iou_similarity', index=3,
...
_THRESHOLDEDIOUSIMILARITY = _descriptor.Descriptor(
  ...
  full_name='protos.ThresholdedIouSimilarity',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='iou_threshold', full_name='protos.ThresholdedIouSimilarity.iou_threshold', index=0,
...
ThresholdedIouSimilarity = _reflection.GeneratedProtocolMessageType('ThresholdedIouSimilarity', (_message.Message,), dict(
  ...
  __module__ = 'protos.region_similarity_calculator_pb2'
  # @@protoc_insertion_point(class_scope:protos.ThresholdedIouSimilarity)
  ))
