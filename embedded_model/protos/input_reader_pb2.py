...
_INPUTREADER = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='name', full_name='protos.InputReader.name', index=0,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='label_map_path', full_name='protos.InputReader.label_map_path', index=1,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='shuffle', full_name='protos.InputReader.shuffle', index=2,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='shuffle_buffer_size', full_name='protos.InputReader.shuffle_buffer_size', index=3,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='filenames_shuffle_buffer_size', full_name='protos.InputReader.filenames_shuffle_buffer_size', index=4,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='num_epochs', full_name='protos.InputReader.num_epochs', index=5,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='sample_1_of_n_examples', full_name='protos.InputReader.sample_1_of_n_examples', index=6,
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='num_parallel_batches', full_name='protos.InputReader.num_parallel_batches', index=8,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='num_prefetch_batches', full_name='protos.InputReader.num_prefetch_batches', index=9,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='queue_capacity', full_name='protos.InputReader.queue_capacity', index=10,
    ...
    _descriptor.FieldDescriptor(
      name='min_after_dequeue', full_name='protos.InputReader.min_after_dequeue', index=11,
      ...
      options=_descriptor._ParseOptions(descriptor_pb2.FieldOptions(), _b('\030\001'))),
    _descriptor.FieldDescriptor(
      name='read_block_length', full_name='protos.InputReader.read_block_length', index=12,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='prefetch_size', full_name='protos.InputReader.prefetch_size', index=13,
      ...
      options=_descriptor._ParseOptions(descriptor_pb2.FieldOptions(), _b('\030\001'))),
    _descriptor.FieldDescriptor(
      name='num_parallel_map_calls', full_name='protos.InputReader.num_parallel_map_calls', index=14,
      ...
      options=_descriptor._ParseOptions(descriptor_pb2.FieldOptions(), _b('\030\001'))),
    _descriptor.FieldDescriptor(
      name='num_additional_channels', full_name='protos.InputReader.num_additional_channels', index=15,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='num_keypoints', full_name='protos.InputReader.num_keypoints', index=16,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='max_number_of_boxes', full_name='protos.InputReader.max_number_of_boxes', index=17,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='load_instance_masks', full_name='protos.InputReader.load_instance_masks', index=18,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='mask_type', full_name='protos.InputReader.mask_type', index=19,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='use_display_name', full_name='protos.InputReader.use_display_name', index=20,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='tf_record_input_reader', full_name='protos.InputReader.tf_record_input_reader', index=21,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='external_input_reader', full_name='protos.InputReader.external_input_reader', index=22,
