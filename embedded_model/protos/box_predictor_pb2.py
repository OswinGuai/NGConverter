...
_WEIGHTSHAREDCONVOLUTIONALBOXPREDICTOR_SCORECONVERTER = _descriptor.EnumDescriptor(
  name='ScoreConverter',
  full_name='protos.WeightSharedConvolutionalBoxPredictor.ScoreConverter',
  filename=None,
  file=DESCRIPTOR,
  values=[
...
_WEIGHTSHAREDCONVOLUTIONALBOXPREDICTOR_BOXENCODINGSCLIPRANGE = _descriptor.Descriptor(
  ...
  full_name='protos.WeightSharedConvolutionalBoxPredictor.BoxEncodingsClipRange',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='min', full_name='protos.WeightSharedConvolutionalBoxPredictor.BoxEncodingsClipRange.min', index=0,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='max', full_name='protos.WeightSharedConvolutionalBoxPredictor.BoxEncodingsClipRange.max', index=1,
...
_WEIGHTSHAREDCONVOLUTIONALBOXPREDICTOR = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='share_prediction_tower', full_name='protos.WeightSharedConvolutionalBoxPredictor.share_prediction_tower', index=8,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='use_depthwise', full_name='protos.WeightSharedConvolutionalBoxPredictor.use_depthwise', index=9,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='score_converter', full_name='protos.WeightSharedConvolutionalBoxPredictor.score_converter', index=10,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='box_encodings_clip_range', full_name='protos.WeightSharedConvolutionalBoxPredictor.box_encodings_clip_range', index=11,
...
_MASKRCNNBOXPREDICTOR = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='convolve_then_upsample_masks', full_name='protos.MaskRCNNBoxPredictor.convolve_then_upsample_masks', index=13,
      number=14, type=8, cpp_type=7, label=1,
      has_default_value=True, default_value=False,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_WEIGHTSHAREDCONVOLUTIONALBOXPREDICTOR.fields_by_name['conv_hyperparams'].message_type = protos_dot_hyperparams__pb2._HYPERPARAMS
...
WeightSharedConvolutionalBoxPredictor = _reflection.GeneratedProtocolMessageType('WeightSharedConvolutionalBoxPredictor', (_message.Message,), dict(
  ...
  BoxEncodingsClipRange = _reflection.GeneratedProtocolMessageType('BoxEncodingsClipRange', (_message.Message,), dict(
    ...
    __module__ = 'protos.box_predictor_pb2'
    # @@protoc_insertion_point(class_scope:protos.WeightSharedConvolutionalBoxPredictor.BoxEncodingsClipRange)
    ))
  ,
